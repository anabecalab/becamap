...
function App() {
    ...
    // Filter scholarships when filters change
    useEffect(() => {
    ...
    const handleSave = async (updatedScholarship) => {
        try {
            console.log('💾 Saving scholarship:', updatedScholarship.id)
            console.log('📝 Updated data:', updatedScholarship)
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <img src="/logo.png" alt="BecaLab Logo" className="h-12 w-12" />
                            <div>
                                <h1 className="text-3xl font-bold text-white">BecaMap Admin Panel</h1>
                                <p className="mt-1 text-sm" style={{ color: '#D5ED86' }}>La base de becas más grande de LATAM by BecaLab</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
